function [] = RNAscope_quant_dorsalhorn(path_folder,filename,chan1name,chan2name,chan3name,chan4name,manual_th,fig_flag)
...
bwgeneC1 = imextendedmax(geneC1,7000, 4);
bwgeneC1 = imfill(bwgeneC1,'holes');
bwgeneC1 = bwgeneC1 - bwareaopen(bwgeneC1,20);

bwgeneC2 = imextendedmax(geneC2,7000, 4);
bwgeneC2 = imfill(bwgeneC2,'holes');
bwgeneC2 = bwgeneC2 - bwareaopen(bwgeneC2,20);

bwgeneC4 = imextendedmax(geneC4,7000, 4);
bwgeneC4 = imfill(bwgeneC4,'holes');
bwgeneC4 = bwgeneC4 - bwareaopen(bwgeneC4,20);
