...
hbbgene = cellfun(@(x) ~isempty(strfind(x,'Hbb-')),geneuni(:,1)) | cellfun(@(x) ~isempty(strfind(x,'Hba-')),geneuni(:,1)) | cellfun(@(x) ~isempty(strfind(x,'Rn4.5')),geneuni(:,1));
...
% % 
% save(['data_gaba_noIEG_after_backspinv7_lev',num2str(splitlev),'_dorsalhorn_gabaonly_',date],'dataout_sorted', 'cells_sorted', 'genes_sorted'...
...
% % 
% eval(['export_fig -r2000 gaba_noIEG_lev',num2str(splitlev),'_',date,'.pdf ']);
...
% % 
% eval(['export_fig barplots_gaba_noIEG_top2_sum_backspinv7_lev',num2str(splitlev),'_',date,'.pdf'])
% 
...
eval(['export_fig barplots_GABAmarkers_noIEG_lev',num2str(splitlev),'_',date,'.pdf'])



% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% % barplots with immediate early genes (IEGs)
% 
% 
...
% 
% % 
% % eval(['export_fig barplots_IEG_gaba_lev',num2str(splitlev),'_',date,'.pdf'])
% % 
...
% % 
% eval(['export_fig heatmap_for_gaba_noIEG_markertable_backspinv7_lev',num2str(splitlev),'_',date,'.pdf'])
% % 
