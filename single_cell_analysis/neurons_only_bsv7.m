...
green_1 = green_1(loc_neurons);
strain_1 = strain_1(loc_neurons);
cellid_1 = cellid_1(loc_neurons);
donorid_1 = donorid_1(loc_neurons);
...
% 
% save(['data_neurons_after_backspinv7_lev',num2str(splitlev),'_dorsalhorn_neuronsonly_',date],'dataout_sorted', 'cells_sorted', 'genes_sorted'...
%     ,'genes_bor_level','cells_bor_level','genes_gr_level','cells_gr_level','splitlev','Nfeture','N_to_backspin','N_to_cells','mean_tresh','fdr_th','min_gr_cells','min_gr_genes');
...
eval(['export_fig -r2000 neurons_lev',num2str(splitlev),'_',date,'.pdf ']);
...
eval(['export_fig barplots_neurons_top2_sum_backspinv7_lev',num2str(splitlev),'_',date,'.pdf'])

% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% % barplots with selected genes


gr_tmp_mark = loadCellFile('allmarkers_july.txt');
...
eval(['export_fig barplots_neurons_markers_july_backspinv7_lev',num2str(splitlev),'_',date,'.pdf'])
...
set(gca,'xtick',[0:200:length(cells_sorted)],'ytick',[1:length(gr_tmp_mark)],'yticklabel',gr_tmp_mark, 'fontsize', 1.5)
colormap('summer');
freezeColors(gca);
...
eval(['export_fig heatmap_for_neurons_markertable_backspinv7_lev',num2str(splitlev),'_',date,'.pdf'])

% %save2pdf(['heatmap_for_neurons_markertable_backspinv7_lev',num2str(splitlev),'_',date,'.pdf'],gcf,300) 
...
saveCellFile(table,['markertable_neurons_backspinv7_lev',num2str(splitlev),'_',date,'.txt'])
