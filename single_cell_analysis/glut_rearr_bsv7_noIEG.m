...
markertable = loadCellFile_turbo('/data2/C1_stuff/Dorsal_horn_MH/Analysis/analysis_jun22/classif_glut_noIEG_bs7_lev5_22-Jul-2016.txt',1);
...
% 
% eval(['export_fig barplots_glut_rearr_noIEG_top2_sum_bsv7_',date,'.pdf'])
...
gr_tmp_mark = loadCellFile('new_list_glut.txt');
...
% 
% eval(['export_fig barplots_GLUTnoIEGmarkers_rearr_,date,'.pdf'])
% 
...
% eval(['export_fig barplots_glut_rearr_neurotransm_noIEG_bsv7_',date,'.pdf'])
% 
...
eval(['export_fig barplots_glut_rearr_peptides_noIEG_bsv7_lev',date,'.pdf'])
...
% 
% 
% eval(['export_fig heatmap_glut_rearr_noIEG_markertable_bsv7_',date,'.pdf'])
